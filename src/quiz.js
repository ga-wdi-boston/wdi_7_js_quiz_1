...
// what kind of input are we expecting? ({weekday: true}) ? or ({day: 'Monday'}) or ?
quiz.sleepIn = function(options) { return options.vacation && options.weekday
};
...
quiz.missingChar = function(string, index) {
    if (string.typeof === string) {
        return string[index].splice(index, 1);
    } else {
...
String.backAround = function(string) {
    var temp = string.pop();
    string.unshift(temp);
    return string;
};
